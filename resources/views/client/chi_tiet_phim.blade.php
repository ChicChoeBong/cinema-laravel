        ...
        <div class="container">
            <div class="row align-items-center position-relative">
                    ...
                    <div class="movie-details-content">
                        ...
                        <div class="movie-details-prime mt-3">
                            @foreach ($lichChieu as $key => $value)
                                <a href="/client/dat-ve/{{ $value->_id }}"
                            ...
                            <ul>
                                ...
                                <li class="watch"><a href="{{ isset($phim) ? $phim->trailer : '' }}"
                ...
                <div class="movie-details-btn">
                    <a href="/assets_client/img/poster/movie_details_img.jpg" class="download-btn" download="">Download
                        <img src="fonts/download.svg" alt=""></a>
                </div>
            </div>
        </div>
    </section>
