...
@section('content')
    <section class="blog-area blog-bg" data-background="/assets_client/img/bg/blog_bg.jpg"
                    ...
                    @foreach ($baiViet as $key => $value)
                        ...
                        <div class="blog-post-item">
                            <div class="blog-post-thumb">
                                <a href="/bai-viet/detail/{{ $value->_id }}"><img src="{{ $hinh_anh[0] }}"
                                        alt=""></a>
                            </div>
                            <div class="blog-post-content">
                                <span class="date"><i class="far fa-clock"></i>{{ $value->created_at }}</span>
                                <h2 class="title"><a href="/bai-viet/detail/{{ $value->_id }}">{{ $value->tieu_de }}</a>
                                </h2>
                                ...
                                <div class="blog-post-meta">
                                    ...
                                    <div class="read-more">
                                        <a href="/bai-viet/detail/{{ $value->_id }}">Đọc thêm <i
                                ...
                                <ul>
                                    @foreach ($baiViet as $key => $value)
                                        ...
                                        <li class="rc-post-item">
                                            <div class="thumb">
                                                <a href="/bai-viet/detail/{{ $value->_id }}"><img
                                                        style="width: 100px; height: 80px;" src="{{ $hinh_anh[0] }}"
                                                        alt=""></a>
                                            </div>
                                            <div class="content">
                                                <h5 class="title"><a
                                                        href="/bai-viet/detail/{{ $value->_id }}">{{ $value->tieu_de }}</a>
                                                </h5>
                                                <span class="date"><i
                                                        class="far fa-clock"></i>{{ $value->created_at }}</span>
                                            </div>
                                        </li>
                                    @endforeach
                                </ul>
