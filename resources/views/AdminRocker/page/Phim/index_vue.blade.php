                ...
                <div class="card-body">
                    <form id="createPhimForm">
                        <div class="form-group mt-1">
                            ...
                            <input v-on:keyup="chuyenThangTenPhimSangSlug()" v-model="them_moi.ten_phim" type="text"
                        ...
                        <div class="form-group mt-3">
                            ...
                            <div class="input-group">
                                <input id="hinh_anh" class="form-control" type="text" name="filepath"
                                    placeholder="Chọn hình ảnh phim">
                                ...
                                <tr v-for="(value, key) in ds_phim">
                                    ...
                                    <td class="align-middle text-nowrap">
                                        ...
                                        <button v-on:click="phim_xoa = value" class="btn btn-danger"
                                            data-bs-toggle="modal" data-bs-target="#exampleModal">Xóa Phim</button>
                                    </td>
                                </tr>
                            </tbody>
                            ...
                            <div class="modal fade" id="updateModal" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <input v-model="phim_update._id" type="hidden" name=""
                                                id="">
                                            <div class="form-group mt-3">
                                                <label>Tên Phim</label>
                                            ...
                                            <div class="form-group mt-3">
                                                <label>Mô Tả</label>
                                                <textarea name="update_mo_ta" id="update_mo_ta" class="form-control" placeholder="Nhập vào mô tả phim"
                                            ...
                                            <div class="form-group mt-3">
                                                ...
                                                <div class="input-group">
                                                    <input id="hinh_anh_update" class="form-control" type="text"
                                                        placeholder="Chọn hình ảnh phim" name="filepath">
                                                    <span class="input-group-prepend">
