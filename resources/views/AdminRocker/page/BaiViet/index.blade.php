                            ...
                            <tbody>
                                <tr v-for="(value, key) in list_bai_viet">
                                    ...
                                    <td class="text-nowrap align-middle text-center">
                                        <button v-on:click="doiTrangThai(value._id)" v-if="value.is_open == 1"
                                            class="btn btn-success">Hiển thị</button>
                                        <button v-on:click="doiTrangThai(value._id)" v-else class="btn btn-danger">Tạm
                                            tắt</button>
                                    </td>
                                    <td class="text-nowrap align-middle text-center">
                            ...
                            <div class="modal-dialog modal-xl">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <input type="text" class="form-control" hidden v-model="edit._id">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <label class="form-label">Tiêu đề</label>
