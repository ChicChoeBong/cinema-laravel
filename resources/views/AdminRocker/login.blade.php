...
<head>
    ...
    <!--favicon-->
    <link rel="icon" href="/assets_client/img/logo/cinemalogo.png" type="image/png" />
    <!--plugins-->
                ...
                <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3">
                    <div class="col mx-auto">
                        <div class="mb-4 text-center">
                            <img src="/assets_client/img/logo/cinemalogo.png" style="width: 100px; height: 100px; display: inline-block">
                            <h4 class="logo-text" style="display:inline-block; font-size: 50px; vertical-align: -30px">CHICBONG</h4>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                        ...
                                        <form action="/admin/login" method="post" class="row g-3">
                                                ...
                                                <div class="input-group" id="show_hide_password">
                                                    <input name="password" type="password"
                                                        class="form-control border-end-0" id="inputChoosePassword"
                                                         placeholder="Nhập vào mật khẩu"> <a
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check form-switch">
                                                    ...
                                                    <label class="form-check-label" for="flexSwitchCheckChecked">Nhớ tài
                                                        khoản</label>
                                                </div>
                                            </div>
