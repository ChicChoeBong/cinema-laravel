<div class="topbar d-flex align-items-center">
    <nav class="navbar navbar-expand">
        <div class="topbar-logo-header">
            <div class="">
                <img src="/assets_client/img/logo/cinemalogo.png" class="logo-icon" alt="logo icon">
            </div>
            <div class="">
                <h4 class="logo-text" style="display: inline-block; vertical-align: -10px">CHICBONG</h4>
            </div>
        </div>
