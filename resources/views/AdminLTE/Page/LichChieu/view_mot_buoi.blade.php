                        ...
                        <div class="col-md-6">
                            ...
                            <select v-on:change="updateThoiGian()" v-model="create_lich.id_phim_xxx" class="form-control">
                                <template v-for="(value, key) in list_phim" v-if="value.tinh_trang > 0">
                                    <option v-bind:value="{id_phim : value._id, thoi_luong: value.thoi_luong}">
                        ...
                        <div class="col-md-3">
                            ...
                            <select v-model="create_lich.id_phong" class="form-control">
                                <template v-for="(value, key) in list_phong" v-if="value.tinh_trang == 1">
                                    <option v-bind:value="value._id">@{{ value.ten_phong }}</option>
                                </template>
                            </select>
                        </div>
                    </div>
                        ...
                        <tbody>
                            <tr v-for="(v, k) in list_lich">
                                ...
                                <td class="text-center">
                                    ...
                                    <button v-on:click="deleteLich(v)" class="btn btn-danger mr-1" data-bs-toggle="modal"
                                        data-bs-target="#deleteModal">Xóa Lịch</button>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <p>Bạn có muốn xóa lịch chiếu phim <b
                                                class="text-danger">@{{ delete_lich.ten_phim }}</b> tại phòng <b
                                                class="text-danger">@{{ delete_lich.ten_phong }}</b> này không?</p>
                            ...
                            <div class="modal-dialog modal-xl">
                                <div class="modal-content">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select v-on:change="updateThoiGian()" v-model="update_lich.id_phim"
                                                    ...
                                                    <template v-for="(value, key) in list_phim"
                                                        ...
                                                        <option v-bind:value="value._id">@{{ value.ten_phim }}</option>
                                                    </template>
                                                </select>
                                            </div>
                                            <div class="col-md-3">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary"
                                            data-bs-dismiss="modal">Đóng</button>
                                        <button v-on:click="capNhatLichChieu()" type="button" class="btn btn-primary"
                                            data-bs-dismiss="modal">Cập Nhật Lịch</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <table class="table table-bordered">
                                                <tr v-for="i in (0, tt_phong.hang_ngang)">
                                                    <template v-for="j in (0, tt_phong.hang_doc)">
                                                        ...
                                                        <td v-on:click="doiTrangThaiGhe(ds_ghe[(i - 1) * tt_phong.hang_doc +  j - 1])"
                                                            v-else class="bg-danger text-center align-middle text-white">
                                                            @{{ ds_ghe[(i - 1) * tt_phong.hang_doc + j - 1].ten_ghe }}
                                                        </td>
                                                    </template>
                                                </tr>
        ...
        new Vue({
            ...
            methods: {
                ...
                layDataGhePhong(v) {
                    ...
                    axios
                        .get('/admin/lich-chieu/danh-sach-ghe/' + v._id)
                        .then((res) => {
                            this.ds_ghe = res.data.data;
                        });
