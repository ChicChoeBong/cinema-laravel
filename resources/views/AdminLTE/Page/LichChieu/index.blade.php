                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <input v-model="create_lich.thoi_gian_chieu_chinh" type="number" min="0"
                                class="form-control" placeholder="Nhập thời lượng chiếu chính">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">Thời Lượng Quảng Cáo</label>
                            <input v-model="create_lich.thoi_gian_quang_cao" type="number" min="0"
                                class="form-control" placeholder="Nhập thời gian quảng cáo">
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-md-3">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            ...
                            <div class="form-check form-check-inline">
                                <input v-model="create_lich.thu_1" class="form-check-input" type="checkbox"
                                    id="inlineCheckbox1" value="option1">
                                <label class="form-check-label" for="inlineCheckbox1">Thứ 2</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input v-model="create_lich.thu_2" class="form-check-input" type="checkbox"
